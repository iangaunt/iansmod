...
/** Contains all of the sounds in the mod. */
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> REBOUND_SOUND = registerSoundEvent(
        "rebound_disc"
    );
    ...
    private static RegistryObject<SoundEvent> registerSoundEvent(String name) {
        return SOUND_EVENTS.register(
            name, 
            () -> new SoundEvent(new ResourceLocation(IansMod.MOD_ID, name))
        );
    }
